  ...
  return (
    <footer className="border-t py-16">
      <div className="mx-auto flex w-full max-w-[1440px] flex-col gap-12 md:flex-row md:items-end md:justify-between">
        <div>
          <span className="text-sm tracking-[0.35em] uppercase">Starter</span>
      ...
      <div className="mx-auto mt-16 flex w-full max-w-[1440px] flex-wrap items-center justify-between gap-4 border-t pt-8">
